...
<link rel="stylesheet" type="text/css" href="/AISD/Portals/_default/Skins/HC MegaMenu/blueskin.css">

<link rel="stylesheet" type="text/css" href="/AISD/Portals/_default/Skins/HC MegaMenu/cc.css">
<link rel="stylesheet" href="/AISD/Portals/_default/Skins/HC MegaMenu/css/ionicons.min.css">
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.4.0/css/font-awesome.min.css">
<script src="/AISD/Portals/_default/Skins/HC MegaMenu/js/megamenu.js" type="text/javascript"></script>
<style>
.siteWrapper {
	background: #1e6db8 none repeat scroll 0 0;
}
.sf-menu li {
    background: #2877c2 none repeat scroll 0 0 !important;
}
</style>
			...
			<div class="outerNav" style="box-shadow: 0 0 0 transparent;">
				...
				<div class="nav">
					<div class="menu-container">
        						<div class="menu">
				<ddr:MENU MenuStyle="ulxslt simple" runat="server" />
						</div>
					</div>
				</div>
				</div>
	...
	<div class="siteBody">
		<div class="fullWidth">
			...
			<div class="breadcrumbsearchWrapper" style="border-radius: 5px 5px 0 0;">
				<div class="breadcrumbDiv"><span style="font-weight:bold; color:#333333">You are here: </span> &nbsp;<dnn:BREADCRUMB runat="server" id="dnnBREADCRUMB" Separator="&nbsp;&raquo;&nbsp;" cssclass="Breadcrumb" RootLevel="1" UseTitle="True"  />
				</div>
